---
name: doctor-diagnose-assistant
description: Clinical diagnostic decision support system for physicians. Use when analyzing patient presentations, generating differential diagnoses, or conducting diagnostic workups. Triggers on medical case analysis, symptom assessment, patient history review, or clinical reasoning tasks.
---
...
## WORKFLOW: QUESTION FIRST, DIAGNOSE LATER
